...
#              import ipdb; ipdb.set_trace()
 ...
 #       print()
        ...
        print ("Epoch %03d -- train-loss: %1.5f  accuracy: %1.5f  confidence: %1.5f  magnitude: %1.5f  --  val-loss: %1.5f  accuracy: %1.5f  confidence: %1.5f  magnitude: %1.5f -- saving model: %s" %(
            epoch,
            epoch_running_loss,
